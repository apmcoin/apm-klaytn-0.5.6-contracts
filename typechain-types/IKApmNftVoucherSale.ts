...
export interface IKApmNftVoucherSaleInterface extends utils.Interface {
  ...
  events: {
    "SetApmKrwPrice(address)": EventFragment;
    ...
    "RedeemVoucher(uint256,uint256,string,string,string,string,uint256,uint256,string,uint256,address)": EventFragment;
...
export type SetApmKrwPriceEvent = TypedEvent<[string], { account: string }>;
...
export type RedeemVoucher_uint256_uint256_string_string_string_string_uint256_uint256_string_uint256_address_Event =
  TypedEvent<
    [
      BigNumber,
      BigNumber,
...
export interface IKApmNftVoucherSale extends BaseContract {
  ...
  filters: {
    "SetApmKrwPrice(address)"(
      account?: string | null
    ): SetApmKrwPriceEventFilter;
    SetApmKrwPrice(account?: string | null): SetApmKrwPriceEventFilter;
    ...
    "RedeemVoucher(uint256,uint256,string,string,string,string,uint256,uint256,string,uint256,address)"(
      id?: BigNumberish | null,
      amount?: null,
